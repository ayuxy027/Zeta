...
export function mapBotStatus(eventType: string): string {
  switch (eventType) {
    case "bot.joining_call": return "joining";
    case "bot.in_call_recording": return "joined";
    case "bot.in_call_not_recording": return "waiting";
    case "bot.call_ended": return "left";
    case "bot.done": return "completed";
    case "bot.fatal": return "failed";
