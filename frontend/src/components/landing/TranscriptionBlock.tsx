                        ...
                        <div className="p-6 bg-gray-50 border-r border-gray-200 lg:col-span-3">
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-200">
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-xs font-medium text-gray-700">LINKED APPS</span>
                                </div>
                            ...
                            {activeTab === 'insights' && (
                                <>
                                    <div className="flex items-center space-x-3 mb-6">
                                        ...
                                        <span className="text-sm font-semibold tracking-wide text-gray-900 uppercase">INSIGHTS</span>
                                    </div>
